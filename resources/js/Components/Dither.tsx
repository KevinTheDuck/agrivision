...
class RetroEffectImpl extends Effect {
    ...
    // We need to update uniforms manually if they change in props
    updateUniforms(colorNum: number, pixelSize: number) {
        const uniforms = (this as any).uniforms;
        const colorNumUniform = uniforms.get("colorNum");
        const pixelSizeUniform = uniforms.get("pixelSize");
        if (colorNumUniform) colorNumUniform.value = colorNum;
...
function DitheredWaves({
    ...
    const handlePointerMove = (e: any) => {
        ...
        // In shader uv (0,0) is usually bottom-left or top-left depending on setup.
        // ThreeJS events give us intersections, but here we are using a full screen quad.
        // For simplicity with the provided shader logic, we pass raw canvas coords.
        // However, strict shader logic often requires flipping Y.
    ...
    return (
        <>
            ...
            {/* Invisible plane to capture mouse events if needed */}
            <mesh
