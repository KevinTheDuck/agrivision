            ...
            <div className="min-h-screen bg-background text-foreground flex flex-col font-primary selection:bg-selectionBg selection:text-selectionText">
                ...
                <main className="flex-grow pt-24 pb-12 px-4 relative overflow-hidden">
                    ...
                    <motion.div 
                        ...
                        animate="show"
                    >
                        <motion.div variants={itemVariants} className="mb-8 border-b border-white/10 pb-4">
                        ...
                        <motion.form variants={itemVariants} onSubmit={submit} className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Avatar Section */}
                            <div className="md:col-span-1">
                                <div className="border border-white/10 bg-black/50 backdrop-blur-sm p-6 flex flex-col items-center relative group">
                                    ...
                                    <button 
                                        type="button"
                                        onClick={() => fileInputRef.current?.click()}
                                        className="text-xs font-primary text-brand hover:text-white transition-colors uppercase tracking-wider"
                                    >
                                        [ Upload New Image ]
                                    </button>
                                    
                                    {errors.avatar && (
                                        <p className="text-red-500 text-xs mt-2 font-primary">{errors.avatar}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="md:col-span-2 space-y-6">
                                <div className="border border-white/10 bg-black/50 backdrop-blur-sm p-8 relative">
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <label className="block text-xs font-primary text-zinc-400 uppercase tracking-wider mb-2 flex items-center gap-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand transition-all font-primary text-sm"
                                                placeholder="Enter username..."
                                            />
                                            {errors.name && (
                                                <p className="text-red-500 text-xs mt-1 font-primary">{errors.name}</p>
                                            )}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={data.email}
                                                disabled
                                                className="w-full bg-white/5 border border-white/10 text-zinc-500 px-4 py-3 focus:outline-none cursor-not-allowed font-primary text-sm"
                                                placeholder="Enter email address..."
                                            />
                                            {errors.email && (
                                                <p className="text-red-500 text-xs mt-1 font-primary">{errors.email}</p>
                                            )}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            {errors.flair && (
                                                <p className="text-red-500 text-xs mt-1 font-primary">{errors.flair}</p>
                                            )}
                                        </div>
                                    </div>

                                    <div className="mt-8 flex items-center justify-between">
                                        <div className="text-xs font-primary text-zinc-500">
                                            {recentlySuccessful && (
                ...
                <footer className="py-6 text-center border-t border-white/5 bg-black/50 backdrop-blur-sm relative z-10">
                    <p className="text-[10px] text-zinc-600 font-primary uppercase tracking-widest">
